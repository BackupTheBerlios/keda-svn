...
ComposerPreferences::ComposerPreferences()
    : KDialogBase(TreeList, i18n("Composer Preferences"),
                  Help|Default|Ok|Apply|Cancel, Ok)
{
    ...
    m_pageOne = new ComposerPrefPageOne(frame);

    frame = addPage(i18n("Second Page"), i18n("Page Two Options"));
    m_pageTwo = new ComposerPrefPageTwo(frame);
}

ComposerPrefPageOne::ComposerPrefPageOne(QWidget *parent)
    : QFrame(parent)
{
...
ComposerPrefPageTwo::ComposerPrefPageTwo(QWidget *parent)
    : QFrame(parent)
{
    QHBoxLayout *layout = new QHBoxLayout(this);
    layout->setAutoAdd(true);
