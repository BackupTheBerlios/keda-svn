...
MenuDatabase::MenuDatabase( QWidget *parent ) : QPopupMenu( parent )
	...
	insertItem( "Edit Database",  parent, SLOT( start_composer() ) );
	insertItem( "Adjust Database",  parent, SLOT( start_composer() ) );
	insertItem( "Replace local Database",  parent, SLOT( start_composer() ) );
	insertItem( "Search a part",  parent, SLOT( start_composer() ) );
	}
